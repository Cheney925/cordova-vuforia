...
public class ARModelDisplayView extends GLSurfaceView {

    private static final String LOGTAG = "ARVirtualDisplayView";

    // Constructor.
    public ARModelDisplayView(Context context) {
    ...
    public ARModelDisplayView(Context context, AttributeSet attribute) {
    ...
    public void init(int depth, int stencil) {
        ...
        setZOrderMediaOverlay(true); // Request that GL view's SurfaceView be on top of other SurfaceViews (including CameraPreview's SurfaceView).
